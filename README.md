...
6. Run with Tomcat (for testing purposes you can use the following data for librarian: email - kaliyeva.laura@gmail.com password - 123 and for reader: email - a.kaliyeva@mail.ru password - 123)
