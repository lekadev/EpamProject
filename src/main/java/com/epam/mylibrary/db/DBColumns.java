...
public class DBColumns {
    ...
    public static final String LIBRARIAN_NUMBER_PHONE = "number_phone";
    public static final String READER_DATE_REGISTERED = "date_registered";
